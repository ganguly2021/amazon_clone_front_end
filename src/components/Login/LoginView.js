    ...
    <div className="container mb-5">
      ...
      >
        <div className="card-body">
          ...
          <Link
            to="/register"
            className={`btn btn-dark btn-sm w-100 mt-2 ${rtl}`}
          >
            {t("login.btn_register_text")}
          </Link>
          <a
            href="#"
            className={`btn btn-outline-success btn-sm w-100 mt-2 ${rtl}`}
          >
            <i className="fab fa-google"></i> {t("login.btn_login_google")}
          </a>
          <a
            href="#"
            className={`btn btn-outline-primary btn-sm w-100 mt-2 ${rtl}`}
          >
            <i className="fab fa-facebook-square"></i>{" "}
            {t("login.btn_login_facebook")}
          </a>
        </div>
      </div>
